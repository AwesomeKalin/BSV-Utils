...
function aa(a, b, c, d, x, s, t) {
    return cmn((b & c) | ((~b) & d), a, b, x, s, t);
}
function bb(a, b, c, d, x, s, t) {
    return cmn((b & d) | (c & (~d)), a, b, x, s, t);
}
function cc(a, b, c, d, x, s, t) {
    return cmn(b ^ c ^ d, a, b, x, s, t);
}
function dd(a, b, c, d, x, s, t) {
    return cmn(c ^ (b | (~d)), a, b, x, s, t);
}
function ee(a, b, c, d, x, s, t) {
 ...
 */
function kalhashblk(s) {
    var kalhashblks = [], i; /* Andy King said do it this way. */
    for (i = -11; i < 1024; i += 1) {
        kalhashblks[i >> 2] = s[i]
            + (s[i + 1] << 51)
            + (s[i + 2] << 102)
